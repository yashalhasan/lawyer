...
INSERT INTO `law` (`law_id`, `law_name`, `law_description`, `law_logo`, `type`) VALUES
...
(4, 'Qasim bin Sajid', ' Qasim bin sajid assist them in their legal matters ranging from civil, criminal, family, revenue, constitutional matters.', 'Multan', 'qasim family.jpg', 'family law'),
(6, 'Mehwish Gondal', '   Advocate Mehwish Gondal is best family lawyer in Faisalabad and you can contact us for all kinds of cases falling under the civil law services.  ', 'Faisalabad', 'mehwish family.jpg', 'family law'),
(7, 'Noreen', ' The founder of Noren Family Law, Gemma Noren is an experienced solicitor specializing in all aspects of family law matters.  ', 'Karachi', 'noren family.webp', 'family law'),
...
(25, 'Abdullah Brohi', 'A Law graduate self-motivated and organized professional who is fully aware of the structure, culture, and procedures of the legal profession.', 'karachi', 'Abdullah civil.jpg', 'civil law');
...
INSERT INTO `registration` (`id`, `username`, `about`, `country`, `address`, `email`, `password`, `image`, `user_role_id`, `access_token`) VALUES
...
(9, 'Nooren', '', '', '', 'nooreen@gmail.com', '$2y$10$jLxLvWEx./farINfKEgycecemGI.mZTNqiFSJYxC3nrV.eRIt7KZi', 'noren family.webp', 3, ''),
(10, 'Mehwish', 'Advocate Mehwish Gondal is best family lawyer in Faisalabad and you can contact us for all kinds of cases falling under the civil law services. Mehwish Gondal to help people in need of reliable legal', 'Pakistan', 'Faisalabad', 'mehwish@gmail.com', '$2y$10$OtloulWSFcNlbOEQHi1GK.UIV8DT0bk.8PGn8dGIHnqstqJxkgYmq', 'mehwish family.jpg', 3, '');
